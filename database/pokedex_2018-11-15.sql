...
# Database: pokedex
# Generation Time: 2018-11-15 14:25:43 +0000
# ************************************************************
...
CREATE TABLE `link` (
  ...
  `pokemon_id` int(3) DEFAULT NULL,
  `caught` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `link` (`id`, `user_id`, `pokemon_id`, `caught`)
VALUES
	(1,1,5,1),
	(2,1,9,1),
	(3,4,6,1),
...
INSERT INTO `pokemon` (`id`, `pokemon_name`, `pokemon_type`, `pokemon_type_2`)
VALUES
